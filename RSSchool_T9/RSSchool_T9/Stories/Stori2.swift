...
class Stories2: UIViewController, UIScrollViewDelegate {
    ...
    lazy var storyScroll: UIScrollView = {
        ...
        storyScroll.contentSize = CGSize(width: self.view.frame.size.width, height: 2250)
        return storyScroll
    }()
    ...
    override func viewDidLoad() {
        ...
        let image1 = UIImage(named: "story-2")
        ...
        textView1.text = "The smart little Bird"
        ...
        NSLayoutConstraint.activate([
            ...
            storyView.heightAnchor.constraint(equalToConstant: 1400)
