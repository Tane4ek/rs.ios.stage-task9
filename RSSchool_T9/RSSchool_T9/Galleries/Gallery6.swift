...
class Gallery6: UIViewController, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let image1 = UIImage(named: "doughnut-0")
        ...
        let im1 = UIImage(named: "doughnut-1")
        ...
        let im2 = UIImage(named: "doughnut-2")
        ...
        let im3 = UIImage(named: "doughnut-3")
        ...
        let im4 = UIImage(named: "doughnut-4")
        ...
        let im5 = UIImage(named: "doughnut-5")
