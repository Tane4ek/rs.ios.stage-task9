...
class Gallery3: UIViewController, UIScrollViewDelegate {
    ...
    lazy var storyScroll: UIScrollView = {
        ...
        storyScroll.contentSize = CGSize(width: self.view.frame.size.width, height: 6000)
        return storyScroll
    }()
    ...
    override func viewDidLoad() {
        ...
        let image1 = UIImage(named: "code-0")
        ...
        let sixImage = UIView()
        sixImage.layer.cornerRadius = 18
        sixImage.layer.borderWidth = 1
        sixImage.layer.borderColor = UIColor.white.cgColor
        sixImage.backgroundColor = .black
        sixImage.translatesAutoresizingMaskIntoConstraints = false
       
        let im6 = UIImage(named: "code-6")
        ...
        button6.addTarget(self, action: #selector(sixImageTap(_:)), for: .touchUpInside)
        
        let sevenImage = UIView()
        sevenImage.layer.cornerRadius = 18
        sevenImage.layer.borderWidth = 1
        sevenImage.layer.borderColor = UIColor.white.cgColor
        sevenImage.backgroundColor = .black
        sevenImage.translatesAutoresizingMaskIntoConstraints = false
       
        let im7 = UIImage(named: "code-7")
        ...
        button7.addTarget(self, action: #selector(sevenImageTap(_:)), for: .touchUpInside)
        
        let eightImage = UIView()
        eightImage.layer.cornerRadius = 18
        eightImage.layer.borderWidth = 1
        eightImage.layer.borderColor = UIColor.white.cgColor
        eightImage.backgroundColor = .black
        eightImage.translatesAutoresizingMaskIntoConstraints = false
       
        let im8 = UIImage(named: "code-8")
        ...
        button8.addTarget(self, action: #selector(eightImageTap(_:)), for: .touchUpInside)
        
        let nineImage = UIView()
        nineImage.layer.cornerRadius = 18
        nineImage.layer.borderWidth = 1
        nineImage.layer.borderColor = UIColor.white.cgColor
        nineImage.backgroundColor = .black
        nineImage.translatesAutoresizingMaskIntoConstraints = false
       
        let im9 = UIImage(named: "code-9")
        ...
        button9.addTarget(self, action: #selector(eightImageTap(_:)), for: .touchUpInside)
        
        let tenImage = UIView()
        tenImage.layer.cornerRadius = 18
        tenImage.layer.borderWidth = 1
        tenImage.layer.borderColor = UIColor.white.cgColor
        tenImage.backgroundColor = .black
        tenImage.translatesAutoresizingMaskIntoConstraints = false
       
        let im10 = UIImage(named: "code-10")
        ...
        button10.addTarget(self, action: #selector(eightImageTap(_:)), for: .touchUpInside)
        ...
        storyScroll.addSubview(sixImage)
        sixImage.addSubview(imView6)
        sixImage.addSubview(button6)
        storyScroll.addSubview(sevenImage)
        sevenImage.addSubview(imView7)
        sevenImage.addSubview(button7)
        storyScroll.addSubview(eightImage)
        eightImage.addSubview(imView8)
        eightImage.addSubview(button8)
        storyScroll.addSubview(nineImage)
        nineImage.addSubview(imView9)
        nineImage.addSubview(button9)
        storyScroll.addSubview(tenImage)
        tenImage.addSubview(imView10)
        tenImage.addSubview(button10)
        ...
        NSLayoutConstraint.activate([
            ...
            sixImage.topAnchor.constraint(equalTo: storyScroll.topAnchor, constant: 3353),
            sixImage.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: 20),
            sixImage.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: -20),
            sixImage.heightAnchor.constraint(equalToConstant: 511),
            
            imView6.topAnchor.constraint(equalTo: sixImage.topAnchor, constant: 10),
            imView6.leadingAnchor.constraint(equalTo: sixImage.leadingAnchor, constant: 10),
            imView6.trailingAnchor.constraint(equalTo: sixImage.trailingAnchor, constant: -10),
            imView6.bottomAnchor.constraint(equalTo: sixImage.bottomAnchor, constant: -10),
            
            button6.topAnchor.constraint(equalTo: sixImage.topAnchor),
            button6.leadingAnchor.constraint(equalTo: sixImage.leadingAnchor),
            button6.trailingAnchor.constraint(equalTo: sixImage.trailingAnchor),
            button6.bottomAnchor.constraint(equalTo: sixImage.bottomAnchor),
            
            sevenImage.topAnchor.constraint(equalTo: storyScroll.topAnchor, constant: 3884),
            sevenImage.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: 20),
            sevenImage.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: -20),
            sevenImage.heightAnchor.constraint(equalToConstant: 511),
            
            imView7.topAnchor.constraint(equalTo: sevenImage.topAnchor, constant: 10),
            imView7.leadingAnchor.constraint(equalTo: sevenImage.leadingAnchor, constant: 10),
            imView7.trailingAnchor.constraint(equalTo: sevenImage.trailingAnchor, constant: -10),
            imView7.bottomAnchor.constraint(equalTo: sevenImage.bottomAnchor, constant: -10),
            
            button7.topAnchor.constraint(equalTo: sevenImage.topAnchor),
            button7.leadingAnchor.constraint(equalTo: sevenImage.leadingAnchor),
            button7.trailingAnchor.constraint(equalTo: sevenImage.trailingAnchor),
            button7.bottomAnchor.constraint(equalTo: sevenImage.bottomAnchor),
            
            eightImage.topAnchor.constraint(equalTo: storyScroll.topAnchor, constant: 4415),
            eightImage.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: 20),
            eightImage.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: -20),
            eightImage.heightAnchor.constraint(equalToConstant: 511),
            
            imView8.topAnchor.constraint(equalTo: eightImage.topAnchor, constant: 10),
            imView8.leadingAnchor.constraint(equalTo: eightImage.leadingAnchor, constant: 10),
            imView8.trailingAnchor.constraint(equalTo: eightImage.trailingAnchor, constant: -10),
            imView8.bottomAnchor.constraint(equalTo: eightImage.bottomAnchor, constant: -10),
            
            button8.topAnchor.constraint(equalTo: eightImage.topAnchor),
            button8.leadingAnchor.constraint(equalTo: eightImage.leadingAnchor),
            button8.trailingAnchor.constraint(equalTo: eightImage.trailingAnchor),
            button8.bottomAnchor.constraint(equalTo: eightImage.bottomAnchor),
            
            nineImage.topAnchor.constraint(equalTo: storyScroll.topAnchor, constant: 4946),
            nineImage.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: 20),
            nineImage.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: -20),
            nineImage.heightAnchor.constraint(equalToConstant: 511),
            
            imView9.topAnchor.constraint(equalTo: nineImage.topAnchor, constant: 10),
            imView9.leadingAnchor.constraint(equalTo: nineImage.leadingAnchor, constant: 10),
            imView9.trailingAnchor.constraint(equalTo: nineImage.trailingAnchor, constant: -10),
            imView9.bottomAnchor.constraint(equalTo: nineImage.bottomAnchor, constant: -10),
            
            button9.topAnchor.constraint(equalTo: nineImage.topAnchor),
            button9.leadingAnchor.constraint(equalTo: nineImage.leadingAnchor),
            button9.trailingAnchor.constraint(equalTo: nineImage.trailingAnchor),
            button9.bottomAnchor.constraint(equalTo: nineImage.bottomAnchor),
            
            tenImage.topAnchor.constraint(equalTo: storyScroll.topAnchor, constant: 5477),
            tenImage.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: 20),
            tenImage.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: -20),
            tenImage.heightAnchor.constraint(equalToConstant: 511),
            
            imView10.topAnchor.constraint(equalTo: tenImage.topAnchor, constant: 10),
            imView10.leadingAnchor.constraint(equalTo: tenImage.leadingAnchor, constant: 10),
            imView10.trailingAnchor.constraint(equalTo: tenImage.trailingAnchor, constant: -10),
            imView10.bottomAnchor.constraint(equalTo: tenImage.bottomAnchor, constant: -10),
            
            button10.topAnchor.constraint(equalTo: tenImage.topAnchor),
            button10.leadingAnchor.constraint(equalTo: tenImage.leadingAnchor),
            button10.trailingAnchor.constraint(equalTo: tenImage.trailingAnchor),
            button10.bottomAnchor.constraint(equalTo: tenImage.bottomAnchor)
...
//        ])
    ...
    @objc func sixImageTap(_ sender: UIButton) {
        print("tap")
    }
    
    @objc func sevenImageTap(_ sender: UIButton) {
        print("tap")
    }
    
    @objc func eightImageTap(_ sender: UIButton) {
        print("tap")
    }
    
    @objc func nineImageTap(_ sender: UIButton) {
        print("tap")
    }
    
    @objc func tenImageTap(_ sender: UIButton) {
        print("tap")
    }
