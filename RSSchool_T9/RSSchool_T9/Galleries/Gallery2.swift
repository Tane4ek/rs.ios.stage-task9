...
class Gallery2: UIViewController, UIScrollViewDelegate {
    ...
    lazy var storyScroll: UIScrollView = {
        ...
        storyScroll.contentSize = CGSize(width: self.view.frame.size.width, height: 4460)
        return storyScroll
    }()
    ...
    override func viewDidLoad() {
        ...
        let image1 = UIImage(named: "apple-0")
