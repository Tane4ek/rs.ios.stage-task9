...
class Gallery4: UIViewController, UIScrollViewDelegate {
    ...
    lazy var storyScroll: UIScrollView = {
        ...
        storyScroll.contentSize = CGSize(width: self.view.frame.size.width, height: 4950)
        return storyScroll
    }()
    ...
    override func viewDidLoad() {
        ...
        let image1 = UIImage(named: "tesla-0")
