...
class Gallery1: UIViewController, UIScrollViewDelegate {
    ...
    lazy var storyScroll: UIScrollView = {
        ...
        storyScroll.contentSize = CGSize(width: self.view.frame.size.width, height: 3930)
        return storyScroll
    }()
    ...
    override func viewDidLoad() {
        ...
        let image1 = UIImage(named: "minsk-0")
